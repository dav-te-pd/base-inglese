...
// ============================================================
  ...
  window.APP_CONFIG = {
    ...
    configFieldDescriptions: {
      ...
      'episodeSequences': 'L\'ordine degli episodi, e quali lo studente vede. Le frecce spostano, l\'occhio accende e spegne. ⚠️ La lista mostra TUTTI gli episodi che esistono: chi non è ancora nominato dall\'ordine compare in coda, e spostarlo in su lo nomina — non c\'è nessun posto dove scrivere un id, quindi un id sbagliato non si può inserire. ⚠️ E spegnere non cancella niente: i progressi restano e tornano se lo riaccendi. Ricarica la pagina per vedere l\'effetto nella lista degli episodi.',
      'episodiSpenti': 'Gli episodi che lo studente NON vede. Si accende e si spegne dall\'occhio nella lista di episodeSequences: qui si vede la lista che ne risulta. ⚠️ È una lista a parte e non l\'assenza dall\'ordine, perché un episodio che l\'ordine non nomina resta raggiungibile in coda: se le due cose si confondessero, un episodio nuovo nascerebbe spento.',
