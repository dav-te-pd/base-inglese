...
function blocco(censimento) {
  ...
  out.push('');
  out.push('⚠️ **E LA RIGA CHE VA LETTA PRIMA DI FIDARSI DI QUESTO CONTO:**');
  out.push('');
  out.push('> **UN NUMERO CHE SI MUOVE NELLA DIREZIONE CHE TI ASPETTI E\' QUELLO CHE');
  out.push('> CONTROLLI DI MENO.**');
  out.push('');
  out.push('Il caso, 2026-09-11: questo strumento teneva l\'elenco delle attese vere');
  out.push('scritto a mano, fermo a tre helper su otto, e **promuoveva a guardia ogni');
  out.push('attesa che stava prima di una conversione**. Per tre famiglie di seguito il');
  out.push('numero e\' sceso — 186, 154, 108, 90 — e nessuno l\'ha controllato, perche\'');
  out.push('scendeva. Il vero era **56**, e le tre famiglie erano gia\' chiuse. Il conto');
  out.push('contava come debito nuovo l\'effetto del lavoro che il debito lo stava');
  out.push('togliendo.');
  out.push('');
