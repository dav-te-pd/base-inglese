...
async function run() {
  ...
  //   7  dal 2026-09-18, estrazione dello strato `audio` — l'ultimo del 22
  //
  ...
  log('[D] I file di script sono 7 (' + esterni + ' esterni + ' + inline + ' inline)',
    foto.script.length === 7, foto.script.join(', '));
