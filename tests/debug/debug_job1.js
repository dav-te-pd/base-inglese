...
async function run() {
  ...
  await page.evaluate((userName) => {
    ...
    ['mappaEpisodio','personalizzazione','repeatAloud','speakEasy','voiceCoach','quickMatchEngIta','quickMatchItaEng','speedRoundEngIta','speedRoundItaEng','flashcard','dialogoAscoltaRipeti','dialogoRipetiATempo','dialogoContinuo'].forEach(k => {
