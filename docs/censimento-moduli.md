...
| quickMatchEngIta | Studio | ModuleRules | firstAttempt †2 | sì | sì | sì | sì | no | Corretto/Sbagliato | a1-episodio1 → grado A | buildMultipleChoiceOptions, recordMultipleChoiceResult (condivisa con Speed Round), retryQueue, openAttemptPopup | batch2b, batch3, batch7, batch9, batch14, batch15, batch17, batch19, new_features |
| quickMatchItaEng | Studio | ModuleRules | firstAttempt †2 | sì | sì | sì | sì | no | Corretto/Sbagliato | a1-episodio1 → grado A | stesso componente di quickMatchEngIta | batch17, batch18, batch19, batch20 (contenuto) †3 |
