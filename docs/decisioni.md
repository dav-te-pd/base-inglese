...
**Il passo zero è in corso: 0a, 0a-bis e 0c sono fatti.** Resta la corsa completa
che produce il baseline (0b) e il merge in `main` (0d). **Nessun passo della fase 1
è cominciato.**
