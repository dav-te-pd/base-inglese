...
> **La firma è sempre la stessa: un pezzo di conoscenza — una chiave, un oggetto, un numero, un nome — che più di un file deve avere, e che il criterio degli strati non sa assegnare. Perché il criterio divide per QUANDO una cosa gira, e una cosa condivisa non si divide così.**
