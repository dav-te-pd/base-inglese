...
| | Cosa | Da dove viene |
|---|---|---|
| **N.1** | **Il flusso del mix e dei distrattori.** Il campo nella matrice, gli **ammessi** nel JSON già risolti, il file condiviso a fine episodio, e il «viola» per le voci che escono dal giro. Chiude C.6 alla radice: l'app legge e non può sbagliare, perché non crea più niente a runtime. | C.6 |
