...
⚠️ **1.8-bis: ④ e ② SONO FATTI. RESTA SOLO ③ — le età in parole**, contenuto e
meccanismo già decisi (sezione 4.2 del file DATI: `ages.anni`, quattordici
righe, `it` la cifra e `en` la parola; lo slot **elenca** gli id del suo
sottoinsieme).
